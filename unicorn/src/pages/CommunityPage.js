...
//     const res = Client(false).get(`/detail/community/${id}`)
//     props.setCommunity(res.data)
//     const creatorRes = Client(false)(false).get(
//       `/detail/community/${res.data.creator}`
//     )
//     props.setCreator(creatorRes.data)
//     const griefStageRes = Client(false)(false).get(
...
//     const res = Client(false).get(`/detail/community/${id}`)
//     const membersRes = Client(false).get(`/list/community/${res.data.members}`)
//     props.setUnicornUsers(membersRes.data)
//   }

//   const getDiscussions = async () => {
//     const res = Client(false).get(`/list/discussions`)
//     const discussionsCommunityRes = Client(false).get(
...
//       let username = Client(false).get(`/list/discussions/${res.data.user}`)
